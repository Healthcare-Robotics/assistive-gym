...
class Panda(Robot):
    def __init__(self, arm='right'):
        ...
        super(Panda, self).__init__(arm, self.right_arm_joint_indices, self.left_arm_joint_indices, self.right_end_effector, self.left_end_effector, self.toc_base_pos_offset, self.toc_ee_orient_rpy, self.wheelchair_mounted)
    ...
    def init(self, directory, id):
        ...
        super(Panda, self).init(self.body, id)
