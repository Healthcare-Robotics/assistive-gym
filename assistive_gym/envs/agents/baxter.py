...
class Baxter(Robot):
    def __init__(self, arm='right'):
        ...
        toc_base_pos_offset = {'scratch_itch': [0, 0, 0.975], 'feeding': [0, 0.2, 0.975], 'drinking': [0, 0.2, 0.975], 'bed_bathing': [-0.2, 0, 0.975]} # Robot base offset before TOC base pose optimization
