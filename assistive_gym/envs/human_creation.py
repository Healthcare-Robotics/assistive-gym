...
class HumanCreation:
    ...
    def create_human(self, static=True, limit_scale=1.0, skin_color='random', specular_color=[0.1, 0.1, 0.1],
                     gender='random', config=None, mass=None, radius_scale=1.0, height_scale=1.0):
        ...
        linkJointAxis.extend(
            [axis['x'], axis['y'], axis['z'], axis['x'], axis['y'], axis['z'], axis['x'], axis['x'], axis['y'],
             axis['z']])
