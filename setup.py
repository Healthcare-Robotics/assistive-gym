...
setup(name='assistive-gym',
    ...
    install_requires=['gym>=0.2.3', 'pybullet @ git+https://github.com/Zackory/bullet3.git@new_updated_pybullet#egg=pybullet', 'numpy', 'keras', 'tensorflow', 'h5py==2.10.0', 'smplx', 'trimesh'] + ['screeninfo==0.6.1' if sys.version_info >= (3, 6) else 'screeninfo==0.2'],
