...
RUN mkdir -p git/assistive-gym-1.0 && cd git/assistive-gym-1.0 && git clone -b v1.0 https://github.com/Healthcare-Robotics/assistive-gym.git && cd assistive-gym && pip3 install -e .
